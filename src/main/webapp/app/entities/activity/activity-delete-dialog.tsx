...
export const ActivityDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="familyActivitiesApp.activity.delete.question">
        <Translate contentKey="familyActivitiesApp.activity.delete.question" interpolate={{ id: activityEntity.id }}>
