...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELATIONSHIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELATIONSHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELATIONSHIP actions', async () => {
      const expectedActions = [
        {
